...
class IndustryExtension1Controller extends Controller
{
    ...
    public function edit($id)
    {
        ...
        $sectors = Sector::all()->lists('name', 'id');
        $subsectors = Subsector::findOrFail($industry_extension1->occupation->subsector->id)->lists('name', 'id');
        $occupations = Occupation::findOrFail($industry_extension1->occupation->id)->lists('name', 'id');
