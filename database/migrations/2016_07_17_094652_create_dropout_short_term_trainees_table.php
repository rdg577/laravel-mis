...
class CreateDropoutShortTermTraineesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('dropout_short_term_trainees', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('dropout_short_term_trainees');
    }
}
