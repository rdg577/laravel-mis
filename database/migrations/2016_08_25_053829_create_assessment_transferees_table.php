...
class CreateAssessmentTransfereesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('assessment_transferees', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('assessment_transferees');
    }
}
