...
class CreateAssessmentShortTermTraineesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('assessment_short_term_trainees', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('assessment_short_term_trainees');
    }
}
