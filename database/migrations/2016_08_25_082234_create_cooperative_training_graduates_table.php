...
class CreateCooperativeTrainingGraduatesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cooperative_training_graduates', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('cooperative_training_graduates');
    }
}
