...
class CreateCooperativeTrainingShortTermTraineesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cooperative_training_short_term_trainees', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::drop('cooperative_training_short_term_trainees');
    }
}
