...
<h1>Cooperative Training on Transferred Trainees</h1>
...
<?php
$active = "class=active";
$sectors = $isr->getSectorsFromCooperativeTrainingTransferees();
?>
...
<div class="tab-content">
    ...
    @forelse($sectors as $sector)
        ...
        <?php $subsectors = $isr->getSubsectorsFromCooperativeTrainingTransferees($sector->id); ?>
        @foreach($subsectors as $subsector)
            ...
            <div class="panel panel-info new_enrollees" style="margin-top: 0.5em;">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    $entries = $isr->getOccupationsFromCooperativeTrainingTransferees($subsector->id);
                    $entries_total = $isr->getSumOccupationsFromCooperativeTrainingTransferees($subsector->id);
                    ?>
