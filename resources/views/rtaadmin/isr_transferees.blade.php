...
<?php
$active = "class=active";
$sectors = $isr->getSectorsFromTransferees();
?>
...
<div class="tab-content">
    ...
    @forelse($sectors as $sector)
        ...
        <?php $subsectors = $isr->getSubsectorsFromTransferees($sector->id); ?>
        @foreach($subsectors as $subsector)
            ...
            <div class="panel panel-info new_enrollees" style="margin-top: 0.5em;">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    $entries = $isr->getOccupationsFromTransferees($subsector->id);
                    $entries_total = $isr->getSumOccupationsFromTransferees($subsector->id);
                    ?>
