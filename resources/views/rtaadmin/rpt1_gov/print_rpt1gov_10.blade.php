...
@section('content')
    @foreach($sectors as $sector)
        <h1>Report 1 - Government : Assessment Graduates</h1>
            ...
            @if($occupation->subsector->sector->id == $sector->id)
                <div class="panel panel-default occupation">
                    ...
                    <div class="panel-body">
                        <?php
                        $reg_assessment_graduates = $rpt1gov->getRegularAssessmentGraduatesByOccupation($occupation->id);
                        $ext_assessment_graduates = $rpt1gov->getExtensionAssessmentGraduatesByOccupation($occupation->id);
                        ?>
                        <div class="row">
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>{{ $ext_assessment_graduate->ext_level1_male + $ext_assessment_graduate->ext_level1_female }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Level 2</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level2_male }}</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level2_female }}</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level2_male + $ext_assessment_graduate->ext_level2_female }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Level 3</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level3_male }}</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level3_female }}</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level3_male + $ext_assessment_graduate->ext_level3_female }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Level 4</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level4_male }}</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level4_female }}</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level4_male + $ext_assessment_graduate->ext_level4_female }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Level 5</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level5_male }}</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level5_female }}</td>
                                                    <td>{{ $ext_assessment_graduate->ext_level5_male + $ext_assessment_graduate->ext_level5_female }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Total</td>
                                                    ...
                                                    <td>{{ $ext_assessment_graduate->ext_level1_male +
                                                            ...
                                                            $ext_assessment_graduate->ext_level3_male +
                                                            $ext_assessment_graduate->ext_level4_male +
                                                            $ext_assessment_graduate->ext_level5_male +
                                                            $ext_assessment_graduate->ext_level1_female +
                                                            $ext_assessment_graduate->ext_level2_female +
                                                            $ext_assessment_graduate->ext_level3_female +
                                                            $ext_assessment_graduate->ext_level4_female +
                                                            $ext_assessment_graduate->ext_level5_female }}</td>
