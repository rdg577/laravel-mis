...
@section('content')
    ...
    <a href="/report-1/gov-cooperative-training-graduates/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 1 - Government [Cooperative Training on Graduates]</h1>
    ...
    <div class="tab-content">
        ...
        @foreach($sectors as $sector)
            <div id="sector-{{ $sector->id }}" class="tab-pane fade {{ $active }}">
                <div class="panel panel-info cooperative_training_graduates" style="margin-top: 0.5em;">
                    <div class="panel-heading"><a data-toggle="collapse" href="#cooperative_training_graduates">Cooperative Training on Graduates</a></div>
                    <div class="panel-body panel-collapse" id="cooperative_training_graduates">
                            ...
                            @if($occupation->subsector->sector->id == $sector->id)
                                <div class="panel panel-default occupation">
                                    ...
                                    <div class="panel-body">
                                        <?php
                                        $reg_cooperative_training_graduates = $rpt1gov->getRegularCooperativeTrainingGraduatesByOccupation($occupation->id);
                                        $ext_cooperative_training_graduates = $rpt1gov->getExtensionCooperativeTrainingGraduatesByOccupation($occupation->id);
                                        ?>
                                        <div class="row">
                                                        ...
                                                        <table class="table">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>{{ $ext_cooperative_training_graduate->ext_level1_total +
                                                                            $ext_cooperative_training_graduate->ext_level2_total +
                                                                            $ext_cooperative_training_graduate->ext_level3_total +
                                                                            $ext_cooperative_training_graduate->ext_level4_total +
                                                                            $ext_cooperative_training_graduate->ext_level5_total }}</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                    </div>
