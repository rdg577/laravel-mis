...
@section('content')
    ...
    <a href="/report-1/gov-saving-transferees/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 1 - Government [Saving Transferees]</h1>
                            ...
                            @if($occupation->subsector->sector->id == $sector->id)
                                <div class="panel panel-default occupation">
                                    ...
                                    <div class="panel-body">
                                        <?php
                                        $reg_saving_transferees = $rpt1gov->getRegularSavingTransfereesByOccupation($occupation->id);
                                        $ext_saving_transferees = $rpt1gov->getExtensionSavingTransfereesByOccupation($occupation->id);
                                        $regext_saving_transferees = $rpt1gov->getRegExtSavingTransfereesByOccupation($occupation->id);
                                        ?>
                                        <div class="row">
