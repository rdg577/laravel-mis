...
@section('content')
    ...
    <a href="/report-1/non-gov-new-enrollees/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 1 - Non-Government [New Enrollees]</h1>
                            ...
                            @if($occupation->subsector->sector->id == $sector->id)
                                <div class="panel panel-default occupation">
                                    ...
                                    <div class="panel-body">
                                        <?php
                                        $reg_new_enrollees = $rpt1nongov->getRegularNewEnrolleesByOccupation($occupation->id);
                                        $ext_new_enrollees = $rpt1nongov->getExtensionNewEnrolleesByOccupation($occupation->id);
                                        ?>
                                        <div class="row">
