...
@section('content')
    ...
    <a href="/report-1/non-gov-cooperative-training-transferees/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 1 - Non-Government [Cooperative Training on Transferees]</h1>
    ...
    <div class="tab-content">
        ...
        @foreach($sectors as $sector)
            <div id="sector-{{ $sector->id }}" class="tab-pane fade {{ $active }}">
                <div class="panel panel-info cooperative_training_transferees" style="margin-top: 0.5em;">
                    <div class="panel-heading"><a data-toggle="collapse" href="#cooperative_training_transferees">Cooperative Training on Transferees</a></div>
                    <div class="panel-body panel-collapse" id="cooperative_training_transferees">
                            ...
                            @if($occupation->subsector->sector->id == $sector->id)
                                <div class="panel panel-default occupation">
                                    ...
                                    <div class="panel-body">
                                        <?php
                                        $reg_cooperative_training_transferees = $rpt1nongov->getRegularCooperativeTrainingTransfereesByOccupation($occupation->id);
                                        $ext_cooperative_training_transferees = $rpt1nongov->getExtensionCooperativeTrainingTransfereesByOccupation($occupation->id);
                                        ?>
                                        <div class="row">
