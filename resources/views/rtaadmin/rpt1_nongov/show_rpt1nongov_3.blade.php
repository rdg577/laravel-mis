...
@section('content')
    ...
    <a href="/report-1/non-gov-transferees/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 1 - Non-Government [Transferees]</h1>
                            ...
                            @if($occupation->subsector->sector->id == $sector->id)
                                <div class="panel panel-default occupation">
                                    ...
                                    <div class="panel-body">
                                        <?php
                                        $reg_transferees = $rpt1nongov->getRegularTransfereesByOccupation($occupation->id);
                                        $ext_transferees = $rpt1nongov->getExtensionTransfereesByOccupation($occupation->id);
                                        ?>
                                        <div class="row">
