...
@section('content')
    ...
    <a href="/report-1/non-gov-graduates/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 1 - Non-Government [Graduates]</h1>
        ...
        @foreach($sectors as $sector)
            <div id="sector-{{ $sector->id }}" class="tab-pane fade {{ $active }}">
                <div class="panel panel-info graduates" style="margin-top: 0.5em;">
                    <div class="panel-heading"><a data-toggle="collapse" href="#graduates">Graduates</a></div>
                            ...
                            @if($occupation->subsector->sector->id == $sector->id)
                                <div class="panel panel-default occupation">
                                    ...
                                    <div class="panel-body">
                                        <?php
                                        $reg_graduates = $rpt1nongov->getRegularGraduatesByOccupation($occupation->id);
                                        $ext_graduates = $rpt1nongov->getExtensionGraduatesByOccupation($occupation->id);
                                        ?>
                                        <div class="row">
