...
@section('content')
    ...
    <a href="/report-1/non-gov-short-term-trainees/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
                            ...
                            @foreach($occupations as $occupation)
                                @if($occupation->subsector->sector->id == $sector->id)
                                    <div class="col col-lg-4 col-md-6 col-sm-12 col-xs-12">
                                        <?php
                                        $short_term_trainees = $rpt1nongov->getShortTermTraineesByOccupation($occupation->id);
                                        ?>
