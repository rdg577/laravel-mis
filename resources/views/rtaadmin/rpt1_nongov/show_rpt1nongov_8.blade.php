...
@section('content')
    ...
    <a href="/report-1/non-gov-dropout-short-term-trainees/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 1 - Non-Government [Dropouts [Short-Term Trainees]]</h1>
                            ...
                            @if($occupation->subsector->sector->id == $sector->id)
                                <div class="panel panel-default occupation">
                                    ...
                                    <div class="panel-body">
                                        <?php
                                        $reg_dropout_short_term_trainees = $rpt1nongov->getRegularDropoutShortTermTraineesByOccupation($occupation->id);
                                        $ext_dropout_short_term_trainees = $rpt1nongov->getExtensionDropoutShortTermTraineesByOccupation($occupation->id);
                                        ?>
                                        <div class="row">
