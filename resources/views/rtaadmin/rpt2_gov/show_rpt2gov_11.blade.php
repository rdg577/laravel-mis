...
@section('content')
    ...
    <a href="/report-2/gov-assessment-short-term-trainees/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 2 - Government [Assessment-Short Term Trainees]</h1>
