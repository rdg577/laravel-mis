...
@section('content')
    ...
    <a href="/report-2/non-gov-assessment-graduates/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 2 - Non-Government [Assessment-Graduates]</h1>
    ...
    <div class="row">
        @forelse($institutions as $institution)
            <?php
            $rows = $rpt2->getAssessmentGraduatesByInstitutionID($institution->id);
            ?>
            @foreach($rows as $row)
