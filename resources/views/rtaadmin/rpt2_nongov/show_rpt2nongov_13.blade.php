...
@section('content')
    ...
    <a href="/report-2/non-gov-cooperative-training-graduates/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 2 - Non-Government [Cooperative Training-Graduates]</h1>
    ...
    <div class="row">
        @forelse($institutions as $institution)
            <?php
            $rows = $rpt2->getCooperativeTrainingGraduatesByInstitutionID($institution->id);
            ?>
            @foreach($rows as $row)
