...
@section('content')
    ...
    <a href="/report-2/non-gov-new-enrollees/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 2 - Non-Government [New Enrollees]</h1>
    ...
    <div class="row">
        ...
        <?php
            $row_data = $rpt2->getNewEnrolleesByInstitutionID($institution->id);
        ?>
