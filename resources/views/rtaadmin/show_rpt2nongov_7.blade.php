...
@section('content')
    ...
    <a href="/report-2/non-gov-dropout-graduates/print/{{ $report_date->id }}" target="_blank" class="btn btn-info btn-sm">
      <span class="glyphicon glyphicon-print"></span> Print
    </a>
    <h1>Report 2 - Non-Government [Dropout-Graduates]</h1>
    ...
    <div class="row">
        ...
        <?php
            $row_data = $rpt2->getDropoutGraduatesByInstitutionID($institution->id);
        ?>
