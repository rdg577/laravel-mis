...
@if($submitButtonText=='Update')
    ...
    <input type="hidden" name="institution_id" value="{{ $assessment_transferee->institution->id }}">
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $sectors, $assessment_transferee->occupation->subsector->sector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $subsectors, $assessment_transferee->occupation->subsector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('occupation_id', $occupations, $assessment_transferee->occupation->id,
                                                      ['class' => 'form-control',
                                                       'id' => 'occupation']) !!}
    </div>
