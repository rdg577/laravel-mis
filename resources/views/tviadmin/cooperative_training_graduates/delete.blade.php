                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::model($cooperative_training_graduate,
                            ...
                            <a role="button" class="btn btn-success" href="/cooperative-training-graduates/{{ $cooperative_training_graduate->report_date->id }}">No!</a>
                            <p>&nbsp;</p>
                            <table class="table table-stripe">
                                <tbody>
                                    <tr>
                                        <th>Report Schedule :</th>
                                        <td>{{ $cooperative_training_graduate->report_date->petsa }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        {!! Form::close() !!}
