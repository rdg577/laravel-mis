...
@if($submitButtonText=='Update')
    ...
    <input type="hidden" name="institution_id" value="{{ $cooperative_training_graduate->institution->id }}">
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $sectors, $cooperative_training_graduate->occupation->subsector->sector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $subsectors, $cooperative_training_graduate->occupation->subsector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('occupation_id', $occupations, $cooperative_training_graduate->occupation->id,
                                                      ['class' => 'form-control',
                                                       'id' => 'occupation']) !!}
    </div>

    <div class="panel panel-default regular_assessments">
     ...
     <div class="panel panel-default extension_assessments">
