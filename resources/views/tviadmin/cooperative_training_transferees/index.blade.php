...
@section('content')
    ...
    <div class="panel panel-default">
        <div class="panel-heading"><a href="/cooperative-training-transferees/create" title="Add new"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span></a></div>
        <table class="table table-striped">
            <thead>
                <tr>
                    <th colspan="4">Report Schedule</th>
                </tr>
            </thead>
            <tbody>
