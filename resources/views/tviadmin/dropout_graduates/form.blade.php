...
@if($submitButtonText=='Update')
    ...
    <input type="hidden" name="institution_id" value="{{ $dropout_graduate->institution->id }}">
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $sectors, $dropout_graduate->occupation->subsector->sector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $subsectors, $dropout_graduate->occupation->subsector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('occupation_id', $occupations, $dropout_graduate->occupation->id,
                                                      ['class' => 'form-control',
                                                       'id' => 'occupation']) !!}
    </div>
