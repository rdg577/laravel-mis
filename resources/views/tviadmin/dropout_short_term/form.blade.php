...
@if($submitButtonText=='Update')
    ...
    <input type="hidden" name="institution_id" value="{{ $dropout_shortterm->institution->id }}">
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $sectors, $dropout_shortterm->occupation->subsector->sector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $subsectors, $dropout_shortterm->occupation->subsector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('occupation_id', $occupations, $dropout_shortterm->occupation->id,
                                                      ['class' => 'form-control',
                                                       'id' => 'occupation']) !!}
    </div>

    <div class="panel panel-default regular_dropouts">
     ...
     <div class="panel panel-default extension_dropouts">
