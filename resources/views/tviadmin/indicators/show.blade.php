...
@section('content')
    ...
    <div class="row">
        @include('tviadmin.indicators.indicator16', compact('industry_extension'))

        @include('tviadmin.indicators.indicator17', compact('industry_extension'))
    </div>

    <div class="row">
        @include('tviadmin.indicators.indicator18', compact('industry_extension'))
    </div>
