    ...
    @forelse($industry_extension1s as $industry_extension1)
        <div class="panel panel-default">
            <div class="panel-heading">
                <a data-toggle="collapse" href="{{ '#item' . $industry_extension1->id }}"><h4>{{ $industry_extension1->subsector->name }}</h4><span class="glyphicon glyphicon-collapse-down" aria-hidden="true"></span></a>
