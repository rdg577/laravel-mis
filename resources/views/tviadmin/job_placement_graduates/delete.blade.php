                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::model($job_placement_graduate,
                            ...
                            <a role="button" class="btn btn-success" href="/job-placement-graduates/{{ $job_placement_graduate->report_date->id }}">No!</a>
                            <p>&nbsp;</p>
                            <table class="table table-stripe">
                                <tbody>
                                    <tr>
                                        <th>Report Schedule :</th>
                                        <td>{{ $job_placement_graduate->report_date->petsa }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        {!! Form::close() !!}
