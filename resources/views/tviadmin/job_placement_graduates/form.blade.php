...
@if($submitButtonText=='Update')
    ...
    <input type="hidden" name="institution_id" value="{{ $job_placement_graduate->institution->id }}">
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $sectors, $job_placement_graduate->occupation->subsector->sector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $subsectors, $job_placement_graduate->occupation->subsector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('occupation_id', $occupations, $job_placement_graduate->occupation->id,
                                                      ['class' => 'form-control',
                                                       'id' => 'occupation']) !!}
    </div>
