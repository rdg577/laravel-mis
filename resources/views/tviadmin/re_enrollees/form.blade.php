...
@if($submitButtonText=='Update')
    ...
    <input type="hidden" name="institution_id" value="{{ $re_enrollee->institution->id }}">
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $sectors, $re_enrollee->occupation->subsector->sector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $subsectors, $re_enrollee->occupation->subsector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('occupation_id', $occupations, $re_enrollee->occupation->id,
                                                      ['class' => 'form-control',
                                                       'id' => 'occupation']) !!}
    </div>
