...
<h1>Assessment on Transferred Trainees</h1>
...
<?php
$active = "class=active";
$sectors = $isr->getSectorsFromAssessmentTransferees();
?>
...
<div class="tab-content">
    ...
    @forelse($sectors as $sector)
        ...
        <?php $subsectors = $isr->getSubsectorsFromAssessmentTransferees($sector->id); ?>
        @foreach($subsectors as $subsector)
            ...
            <div class="panel panel-info new_enrollees" style="margin-top: 0.5em;">
                ...
                <table class="table">
                    ...
                    <tbody>
                    <?php
                    $entries = $isr->getOccupationsFromAssessmentTransferees($subsector->id);
                    $entries_total = $isr->getSumOccupationsFromAssessmentTransferees($subsector->id);
                    ?>
