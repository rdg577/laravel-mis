...
<h1>Saving on Transferred Trainees</h1>
...
<?php
$active = "class=active";
$sectors = $isr->getSectorsFromSavingTransferees();
?>
        ...
        <div id="sector-{{ $sector->id }}" class="tab-pane fade {{ $active }}">
            ...
            <div class="panel panel-info" style="margin-top: 0.5em;">
                ...
                <table class="table table-responsive">
                    ...
                    <tr>
                        <th>Level 1 to 2</th><th>Level 2 to 3</th><th>Level 3 to 4</th>
                        <th>Level 4 to 5</th><th>Total</th>
                        <th>Level 1 to 2</th><th>Level 2 to 3</th><th>Level 3 to 4</th>
                        <th>Level 4 to 5</th><th>Total</th>
                    </tr>
                    </thead>

                    <?php $rows = $isr->getSumAmountPerSubsectorFromSavingTransferees($sector->id); ?>
                    <tbody>
                    @foreach($rows as $row)
                    ...
                    <?php $rows = $isr->getSumAmountPerSectorFromSavingTransferees($sector->id); ?>
                    <tfoot>
                    @foreach($rows as $row)
                        <tr bgcolor="#f0e68c">
                            <th>TOTAL</th>
            ...
            <div class="panel panel-info" style="margin-top: 0.5em;">
                <div class="panel-heading">Transferees</div>
                <table class="table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        <?php $entries = $isr->getSumPerSubsectorFromSavingTransferees($sector->id); ?>
                    ...
                    <?php $entries_total = $isr->getSumPerSectorFromSavingTransferees($sector->id); ?>
                    @foreach($entries_total as $row)
                        <tfoot>
                            <tr bgcolor="#f0e68c">
                                <th>TOTAL</th>
