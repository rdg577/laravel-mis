                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        {!! Form::model($short_term_training,
                            ...
                            <a role="button" class="btn btn-success" href="/short-term-trainings/{{ $short_term_training->report_date->id }}">No!</a>
                            <p>&nbsp;</p>
                            <table class="table table-stripe">
                                <tbody>
                                    <tr>
                                        <th>Report Date :</th>
                                        <td>{{ $short_term_training->report_date->petsa }}</td>
                                    </tr>
                                    <tr>
                                        <th>Occupation :</th>
                                        <td>{{ $short_term_training->occupation->name }}</td>
                                    </tr>
                                </tbody>
                            </table>
                        {!! Form::close() !!}
