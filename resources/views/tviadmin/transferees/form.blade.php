...
@if($submitButtonText=='Update')
    ...
    <input type="hidden" name="institution_id" value="{{ $transferee->institution->id }}">
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $sectors, $transferee->occupation->subsector->sector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('sector_id', $subsectors, $transferee->occupation->subsector->id,
                                                      ['class' => 'form-control',
    ...
    <div class="form-group">
        ...
        {!! Form::select('occupation_id', $occupations, $transferee->occupation->id,
                                                      ['class' => 'form-control',
                                                       'id' => 'occupation']) !!}
    </div>
